...
export const generateMealPlan = async (
  generateMealPlanRequest: GenerateMealPlanRequest,
  options?: RequestInit,
  ...
  return customFetch<WeeklyMealPlan>(getGenerateMealPlanUrl(), {
    ...
    body: JSON.stringify(generateMealPlanRequest),
  });
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { data: BodyType<GenerateMealPlanRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
export type GenerateMealPlanMutationResult = NonNullable<
  Awaited<ReturnType<typeof generateMealPlan>>
>;
export type GenerateMealPlanMutationBody = BodyType<GenerateMealPlanRequest>;
